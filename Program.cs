...
using SepoliaNftMarket.DbInitializer;
using SepoliaNftMarket.Filters;
...
builder.Services.AddSingleton<ISepoliaService, SepoliaService>();
builder.Services.AddSingleton<IEtherscanProvider, EtherscanProvider>();
builder.Services.AddSingleton<IMoralisProvider, MoralisProvider>();
